...
public class QuanLyHocKyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  get data retrive and show in List View ,,,Lấy lại dữ liệu và hiển thị trong List View
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v)
            {
                ...
                final TextView txtTieuDe = (TextView)mViewQuanLyHocKy.findViewById(R.id.txtTieuDeHocKy);
    ...
    // Create Menu While Long Press ,,,Tạo Menu Trong khi Bấm lâu
    @Override
    ...
    {
        dataHocKy.child(user.getUid()).addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                listHocKy.add(dataSnapshot.getValue().toString());
                adapter.notifyDataSetChanged();
            }
            ...
            public void onChildRemoved(@NonNull DataSnapshot dataSnapshot) {
                listHocKy.remove(dataSnapshot.getValue().toString());
                adapter.notifyDataSetChanged();
