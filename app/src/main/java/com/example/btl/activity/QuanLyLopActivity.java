...
public class QuanLyLopActivity extends AppCompatActivity {
  ...
  //  String[] listClass = {"Mã Nguồn Mở", "Quản Trị Mạng","Giải Tích 2","Lập trình hướng sự kiện"};
    public List<QuanLyLop> lstLop;
    DatabaseReference dataLop;
    public FirebaseUser user;
    public QuanLyLopAdapter adapter;
    public String hocKy;
    public QuanLyLop QLL;
    @Override
